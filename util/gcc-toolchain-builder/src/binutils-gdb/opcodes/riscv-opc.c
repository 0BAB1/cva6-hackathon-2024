...
// Custom MAC op fro CVA6 hackathon
// r operand will extract RS3 (bits 31:27)
{"mac",        32, INSN_CLASS_I, "d,s,t,r",   MATCH_MAC,MASK_MAC, match_opcode, 0},
// Custom load for CVXIF
{"lbc",          32, INSN_CLASS_I, "d,o(s)",    MATCH_LBC, MASK_LBC, match_opcode, INSN_DREF|INSN_1_BYTE },
{"lbcu",         32, INSN_CLASS_I, "d,o(s)",    MATCH_LBCU, MASK_LBCU, match_opcode, INSN_DREF|INSN_1_BYTE },
// {"lbc",          32, INSN_CLASS_I, "d,A",       0, (int) M_LB, match_never, INSN_MACRO },
// {"lbcu",         32, INSN_CLASS_I, "d,A",       0, (int) M_LBU, match_never, INSN_MACRO },
